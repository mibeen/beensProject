...
$vlist[] = array('wuliRJxCS4Y', 30, 0, 0, 'http://amina.co.kr/demo/image/biz03.jpg');
$vlist[] = array('UrkXWG9WgC8', 30, 0, 0, 'http://amina.co.kr/demo/image/biz08.jpg');
$vlist[] = array('1i-eeVU9KN8', 30, 0, 0, 'http://amina.co.kr/demo/image/biz09.jpg');
...
// Main CSS
add_stylesheet('<link rel="stylesheet" href="'.THEMA_URL.'/main/css/company-30.css" type="text/css">',0);
		...
		<section class="section full-zone">
			<div class="op-tbl">
				<div class="op-cell op-cell-title">
					<!-- 헤드라인 영역 -->
					<?php echo apms_widget('miso-post-bxslider', $wid.'-headline', 'skin=title margin=0 heights=460px,460px,56.25%,75%,110% raster=1 nav=2 dot=red in=1 rdm=1 loop=1 data=title'); ?>
				...
				<div class="op-cell op-cell-body">
					...
					<!-- 갤러리 -->
					<div class="op-widget" style="border-bottom:1px solid #ddd;">
						<a href="#이동URL입력">				
							<h3 class="op-subject">
								갤러리
							</h3>
					...
					<div class="op-widget">
						...
						<?php echo apms_widget('miso-post-slider', $wid.'-partner', 'heights=40% auto=1 nav=1 loop=1 rdm=1 items=2,2,4,3,2'); ?>
					</div>
