...
$img = apms_wr_thumbnail($bo_table, $view, 300, 300, false, true);
...
<div class="view-wrap<?php echo (G5_IS_MOBILE) ? ' view-mobile font-14' : '';?>">
	...
	<div class="area-wrap">
		...
		<div class="txt-box">
			...
			<p><span class="title">강의경력</span><?php echo $result['wr_1']?></p>
			<p><span class="title">강의지역</span>경기도 <?php echo $result['wr_3'] . " " . $result['wr_2']?></p>
		</div>
	</div>
	...
	<div class="view-content">
		...
		<?php
			...
			echo get_view_thumbnail(strip_tags($view['content'],'<p><span><img>'));
		?>
		<!-- 
			2017.11.27 Hoyeongkim
			p와 span, img 태그만 허용합니다. 
		-->
