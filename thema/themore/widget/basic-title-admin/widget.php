...
<div id="<?php echo $widget_id;?>" class=" nx-carousel swipe-carousel carousel<?php echo $is_small;?><?php echo $effect;?>" data-ride="carousel" data-interval="<?php echo $interval;?>">
					...
					<div class="img-wrap">
						<div class="img-item">
							...
							<?php if($list[$i]['cs'] && $list[$i]['caption']) { // 캡션 ?>
								<div class="en nx-in-<?php echo $list[$i]['cs'];?>-wrap1">
									<div class="nx-in-title-wrap2">
										<div class="nx-in-title-wrap3">
											<div class="nx-in-title font-<?php echo $list[$i]['cf'];?> trans-bg-<?php echo $list[$i]['cc'];?>">
...
<?php } ?>
<br/><br/><br/>
<a href="<?php echo $setup_href;?>" target="_blank" class="pull-right nx_btn2">위젯설정</a>
