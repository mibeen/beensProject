...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">이미지글 여백</td>
		<td>
			좌측 <input type="text" name="wset[marginLeft]" value="<?php echo $wset['marginLeft']; ?>" class="frm_input" size="4">px <br>
			<!-- 하단 <input type="text" name="wset[marginBottom]" value="<?php echo $wset['marginBottom']; ?>" class="frm_input" size="4">px <br> -->
	...
	<tr>
		<td align="center">글쓴이 표시 여부</td>
		<td>
			<select name="wset[wrname]">
				<option value="0"<?php echo get_selected('0', $wset['wrname']);?>>표시 안함</option>
				<option value="1"<?php echo get_selected('1', $wset['wrname']);?>>표시</option>
			</select>
		</td>
	</tr>
	<tr>
