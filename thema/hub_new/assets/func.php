...
function miso_item_select($val, $ary='', $rdm=true) {
...
// 타이틀 위젯용
function miso_callback_widget($m) {
	list($w1, $w2, $w3, $w4) = explode('|', $m[2]);
	return apms_widget($w1, $w2, $w3, $w4);
}

function miso_callback_addon($m) {
	list($w1, $w2, $w3, $w4) = explode('|', $m[2]);
	return apms_addon($w1, $w2, $w3, $w4);
}

function miso_html_content($html) {
	...
	$html = preg_replace_callback("/{(위젯|widget)\:([^}]*)}/is", "miso_callback_widget", $html); // Widget
	$html = preg_replace_callback("/{(애드온|addon)\:([^}]*)}/is", "miso_callback_addon", $html); // Addon

	return $html;
}

// BG Options
function miso_bg_options($value) {

	$options = '<option value="center"'.get_selected('center', $value).'>중앙맞춤</option>'.PHP_EOL;
	$options .= '<option value="top"'.get_selected('top', $value).'>상단맞춤</option>'.PHP_EOL;
	$options .= '<option value="bottom"'.get_selected('bottom', $value).'>하단맞춤</option>'.PHP_EOL;
	$options .= '<option value="fixed"'.get_selected('fixed', $value).'>상단고정</option>'.PHP_EOL;
	$options .= '<option value="pattern"'.get_selected('pattern', $value).'>패턴배경</option>'.PHP_EOL;

	return $options;
}

// Opacity Options
function miso_opacity_options($value) {
	
	$options = '<option value="0"'.get_selected('0', $value).'>사용안함</option>'.PHP_EOL;
	$options .= '<option value="10"'.get_selected('10', $value).'>10%</option>'.PHP_EOL;
	$options .= '<option value="20"'.get_selected('20', $value).'>20%</option>'.PHP_EOL;
	$options .= '<option value="30"'.get_selected('30', $value).'>30%</option>'.PHP_EOL;
	$options .= '<option value="40"'.get_selected('40', $value).'>40%</option>'.PHP_EOL;
	$options .= '<option value="50"'.get_selected('50', $value).'>50%</option>'.PHP_EOL;
	$options .= '<option value="60"'.get_selected('60', $value).'>60%</option>'.PHP_EOL;
	$options .= '<option value="70"'.get_selected('70', $value).'>70%</option>'.PHP_EOL;
	$options .= '<option value="75"'.get_selected('75', $value).'>75%</option>'.PHP_EOL;
	$options .= '<option value="80"'.get_selected('80', $value).'>80%</option>'.PHP_EOL;
	$options .= '<option value="85"'.get_selected('85', $value).'>85%</option>'.PHP_EOL;
	$options .= '<option value="90"'.get_selected('90', $value).'>90%</option>'.PHP_EOL;
	$options .= '<option value="95"'.get_selected('95', $value).'>95%</option>'.PHP_EOL;

	return $options;
}

// Raster Options
function miso_raster_options($value) {
	
	$options = '<option value="0"'.get_selected('0', $value).'>사용안함</option>'.PHP_EOL;
	$options .= '<option value="1"'.get_selected('1', $value).'>1번</option>'.PHP_EOL;
	$options .= '<option value="2"'.get_selected('2', $value).'>2번</option>'.PHP_EOL;
	$options .= '<option value="3"'.get_selected('3', $value).'>3번</option>'.PHP_EOL;
	$options .= '<option value="4"'.get_selected('4', $value).'>4번</option>'.PHP_EOL;
	$options .= '<option value="5"'.get_selected('5', $value).'>5번</option>'.PHP_EOL;

	return $options;
}

// Mask Options
function miso_mask_options($value) {

	$options = '<option value="none"'.get_selected('none', $value).'>사용안함</option>'.PHP_EOL;
	$options .= '<option value="a"'.get_selected('a', $value).'>마스크 A</option>'.PHP_EOL;
	$options .= '<option value="b"'.get_selected('b', $value).'>마스크 B</option>'.PHP_EOL;
	$options .= '<option value="c"'.get_selected('c', $value).'>마스크 C</option>'.PHP_EOL;
	$options .= '<option value="d1"'.get_selected('d1', $value).'>마스크 D1</option>'.PHP_EOL;
	$options .= '<option value="d2"'.get_selected('d2', $value).'>마스크 D2</option>'.PHP_EOL;
	$options .= '<option value="e1"'.get_selected('e1', $value).'>마스크 E1</option>'.PHP_EOL;
	$options .= '<option value="e2"'.get_selected('e2', $value).'>마스크 E2</option>'.PHP_EOL;
	$options .= '<option value="e3"'.get_selected('e3', $value).'>마스크 E3</option>'.PHP_EOL;
	$options .= '<option value="e4"'.get_selected('e4', $value).'>마스크 E4</option>'.PHP_EOL;
	$options .= '<option value="f"'.get_selected('f', $value).'>마스크 F</option>'.PHP_EOL;
	$options .= '<option value="g1"'.get_selected('g1', $value).'>마스크 G1</option>'.PHP_EOL;
	$options .= '<option value="g2"'.get_selected('g2', $value).'>마스크 G2</option>'.PHP_EOL;
	$options .= '<option value="h1"'.get_selected('h1', $value).'>마스크 H1</option>'.PHP_EOL;
	$options .= '<option value="h2"'.get_selected('h2', $value).'>마스크 H2</option>'.PHP_EOL;
	$options .= '<option value="i1"'.get_selected('i1', $value).'>마스크 I1</option>'.PHP_EOL;
	$options .= '<option value="i2"'.get_selected('i2', $value).'>마스크 I2</option>'.PHP_EOL;
	$options .= '<option value="j"'.get_selected('j', $value).'>마스크 J</option>'.PHP_EOL;
	$options .= '<option value="k1"'.get_selected('k1', $value).'>마스크 K1</option>'.PHP_EOL;
	$options .= '<option value="k2"'.get_selected('k2', $value).'>마스크 K2</option>'.PHP_EOL;
	$options .= '<option value="k3"'.get_selected('k3', $value).'>마스크 K3</option>'.PHP_EOL;
	$options .= '<option value="l"'.get_selected('l', $value).'>마스크 L</option>'.PHP_EOL;
	$options .= '<option value="m"'.get_selected('m', $value).'>마스크 M</option>'.PHP_EOL;

	return $options;
}

// SVG Mask
function miso_mask($type, $mask, $fill='#fff', $color='#cd2122') {

	if(!$mask || $mask == 'none') return;

	$rev = ($type == "head") ? ' miso-mask-rev' : '';
...
<div class="miso-mask miso-mask-a$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-b mask-zone mask-height"></div>
<div class="miso-mask miso-mask-b$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="mask-svg" viewBox="0 0 2700 57" width="2700px" height="57px" version="1.1">
		<defs>
			<filter id="$id" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox">
...
echo <<<HTMLCODE
<div class="miso-mask-c mask-zone mask-height"></div>
<div class="miso-mask miso-mask-c$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="miso-mask mask-fill" viewBox="0 0 767 60" preserveAspectRatio="none meet" width="767px" height="60px" version="1.1">
		<polygon fill="$color" points="767,0 767,50 0,60" />
	</svg>
	<svg xmlns="http://www.w3.org/2000/svg" class="miso-mask mask-over" viewBox="0 0 767 50" preserveAspectRatio="none meet" width="767px" height="50px" version="1.1">
...
<div class="miso-mask miso-mask-d1$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-d2 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-d2$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="mask-svg" viewBox="0 0 5000 57" width="5000px" height="57px" version="1.1">
		<defs>
			<filter id="$id" x="-50%" y="-50%" width="200%" height="200%" filterUnits="objectBoundingBox">
...
echo <<<HTMLCODE
<div class="miso-mask-e1 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-e1$rev"><div class="mask-fill" style="background-color: $fill;"></div></div>
HTMLCODE;

	} else if($mask == "e2") {

echo <<<HTMLCODE
<div class="miso-mask-e2 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-e2$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-e3 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-e3$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-e4 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-e4$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-f mask-zone mask-height"></div>
<div class="miso-mask miso-mask-f$rev"><div class="mask-fill" style="background-color: $fill;"></div></div>
HTMLCODE;
...
echo <<<HTMLCODE
<div class="miso-mask-g1 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-g1$rev">
...
<div class="miso-mask miso-mask-g2$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-h mask-zone mask-height"></div>
<div class="miso-mask miso-mask-h$rev">
	<svg xmlns="http://www.w3.org/2000/svg" class="mask-svg" viewBox="0 0 2560 80" width="2560px" height="80px" version="1.1">
...
echo <<<HTMLCODE
<div class="miso-mask-i1 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-i1$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-i2 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-i2$rev">
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2560 16" width="2560px" height="16px" version="1.1">
		<defs>
...
<div class="miso-mask miso-mask-j$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-k1 mask-zone mask-height"></div>
<div class="miso-mask miso-mask-k1$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-k mask-zone mask-height"></div>
<div class="miso-mask miso-mask-k$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-l mask-zone mask-height"></div>
<div class="miso-mask miso-mask-l$rev">
...
echo <<<HTMLCODE
<div class="miso-mask-m mask-zone mask-height"></div>
<div class="miso-mask miso-mask-m$rev">
