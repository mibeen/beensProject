...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<?php echo help('강조하는 글의 순번을 콤마(,)로 구분해서 등록. <br>바(|)를 이용하여 red, blue, green, crimson, orangred 등의 기본 컬러설정 가능. ex) 1|red,4|blue,6');?><br>
	...
	<tr>
		...
		<td>
			<?php echo help('회원아이디를 콤마(,)로 구분해서 복수 등록 가능');?><br>
