...
<div id="bo_w" class="write-wrap<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<div class="input-group">
				<input type="text" name="wr_datetime" value="<?php echo $write['wr_datetime'] ?>" id="wr_writedate" required class="form-control input-sm" size="50" maxlength="255" placeholder="<?php echo date('Y-m-d H:i:s');?>">
			</div>
		</div>
	</div>
	<?php } ?>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<div class="input-group">
				...
				?>
				<input type="checkbox" name="sh_3[]" value="전국" id="pl_1" <?php confirm_ck('전국',$place_split) ?>><label for="pl_1">전국</label>
				<input type="checkbox" name="sh_3[]" value="서울" id="pl_2" <?php confirm_ck('서울',$place_split) ?>><label for="pl_2">서울</label>
				<input type="checkbox" name="sh_3[]" value="경기" id="pl_3" <?php confirm_ck('경기',$place_split) ?>><label for="pl_3">경기</label>
				<input type="checkbox" name="sh_3[]" value="강원" id="pl_4" <?php confirm_ck('강원',$place_split) ?>><label for="pl_4">강원</label>
				<input type="checkbox" name="sh_3[]" value="충남" id="pl_5" <?php confirm_ck('충남',$place_split) ?>><label for="pl_5">충남</label>
				<input type="checkbox" name="sh_3[]" value="충북" id="pl_6" <?php confirm_ck('충북',$place_split) ?>><label for="pl_6">충북</label>
				<input type="checkbox" name="sh_3[]" value="전남" id="pl_7" <?php confirm_ck('전남',$place_split) ?>><label for="pl_7">전남</label>
				<input type="checkbox" name="sh_3[]" value="전북" id="pl_8" <?php confirm_ck('전북',$place_split) ?>><label for="pl_8">전북</label>
				<input type="checkbox" name="sh_3[]" value="경남" id="pl_9" <?php confirm_ck('경남',$place_split) ?>><label for="pl_9">경남</label>
				<input type="checkbox" name="sh_3[]" value="경북" id="pl_10" <?php confirm_ck('경북',$place_split) ?>><label for="pl_10">경북</label>
