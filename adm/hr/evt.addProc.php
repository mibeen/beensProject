<?php
	...
	# insert : event master
	$sql = "Insert Into NX_EVENT_HR_MASTER("
		."EC_IDX"
		.", EP_IDX"
		.", mb_id"
		.", EM_TITLE"
	...
	# update XX_FORM_ITEM
	$sql = "Update NX_EVENT_HR_FORM_ITEM Set EM_IDX = '" . mres($EM_IDX) . "' Where FI_DDATE is null And EM_IDX is null And FI_RNDCODE = '" . mres($FI_RNDCODE) . "'";
	sql_query($sql);
