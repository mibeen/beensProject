...
<div class="form-group">
	...
	<div class="col-sm-3">
		<div class="control-label input-group input-group-sm">
			...
			<input type="text" name="wr_1" value="<?php echo ($is_new) ? $fr_date : $write['wr_1'];?>" id="wr_1" <?php echo $is_required;?> <?php echo $data_readonly ?> class="form-control input-sm" size="10" maxlength="20">
	...
	<div class="col-sm-3">
		<div class="control-label input-group input-group-sm">
			...
			<input type="text" name="wr_2" value="<?php echo ($is_new) ? $fr_date : $write['wr_2'];?>" id="wr_2" <?php echo $is_required;?> <?php echo $data_readonly ?> class="form-control input-sm" size="10" maxlength="20">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		</div>
		<div class="h10 visible-xs"></div>
	</div>
