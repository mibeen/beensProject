...
<div class="local_ov01 local_ov">
    전체회원 <?php echo number_format($tot_cnt) ?>명 , 탈퇴대기회원 <?php echo number_format($finish_cnt) ?>명, 정상회원 <?php echo number_format($tot_cnt - $finish_cnt) ?>명 중 SMS 발송 대상 선택
</div>

<form name="frmsendmailselectform" id="frmsendmailselectform" action="./sms_select_list.php" method="post" autocomplete="off">
<input type="hidden" name="ma_id" value="<?php echo $ma_id ?>">
<input type="hidden" name="ma_target" value="A">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            <?php echo help("휴대폰번호 주소에 단어 포함 (예 : 010-1111-2222)") ?>
            <input type="text" name="mb_hp" value="<?php echo $mb_hp ?>" id="mb_hp" class="frm_input" size="50">
        </td>
    </tr>
    <tr>
