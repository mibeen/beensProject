...
<section itemscope itemtype="http://schema.org/NewsArticle">
	<article itemprop="articleBody">
		<div class="area-wrap">
			...
			<p><span class="title"><span class="dot">· </span>신청자 성명(기관명)</span> <?php echo F_hsc($view['wr_1']) ?></p>
			<p><span class="title"><span class="dot">· </span>연락처</span> <?php echo F_hsc($view['wr_2']) ?></p>
			<p><span class="title"><span class="dot">· </span>대상(인원)</span> <?php echo F_hsc($view['wr_6']) ?></p>
			<p><span class="title"><span class="dot">· </span>지역</span> <?php echo (($view['wr_8'] == '기타') ? $view['wr_9'] : $view['wr_8']); ?></p>
			<p><span class="title"><span class="dot">· </span>장소제공 여부</span> <?php echo (($view['wr_7'] == 'A') ? '제공' : '미제공'); ?></p>
			<p><span class="title"><span class="dot">· </span>모집기간</span> <?php echo (($view['wr_3'] == 'A') ? '상시모집' : $view['wr_4'] . ' ~ ' . $view['wr_5']); ?></p>
		</div>

		<div class="view-padding">
				
			<h3 class="area-title">교육 내용</h3>
