...
$btn1 = isset($btn1) ? $btn1 : 'black';
$btn2 = isset($btn2) ? $btn2 : 'color';
?>
	...
	<div class="list-wrap">
			...
			<?php if ($is_checkbox || $setup_href || $admin_href) { ?>
				<div class="list-admin">
					<div class="btn-group" role="group">
						<?php if ($is_checkbox) { ?>
							<button type="button" id="btn_chkall" class="btn-chkall btn btn-<?php echo $btn1;?> btn-sm"><i class="fa fa-check"></i><span class="hidden-xs"> 전체선택</span></button>
		...
		-->
			...
			<div class="list-btn-box">
				...
				<div class="form-group list-btn font-12 pull-left">
					<div class="btn-group">
						<a href="#" class="btn btn-black btn-sm" data-toggle="modal" data-target="#searchModal" onclick="return false;"><i class="fa fa-search"></i> 검색</a>
						<?php if ($rss_href) { ?>
							<a href="<?php echo $rss_href; ?>" class="btn btn-color btn-sm"><i class="fa fa-rss"></i></a>
						<?php } ?>
					</div>
							...
							<strong>
								<a href="<?php echo $list[$i]['href'];?>"<?php echo $ellipsis;?>>
									<?php if($wr_id && $list[$i]['wr_id'] == $wr_id) {?>
										<span class="crimson"><?php echo F_hsc($list[$i]['subject']);?></span>
									<?php } else { ?>
										<?php echo F_hsc($list[$i]['subject']);?>
									<?php } ?>
