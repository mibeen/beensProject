		...
		<tr>
			...
			<td>
				<select name="wset[cs<?php echo $i;?>]">
					...
					<option value="use"<?php echo get_selected('use', $wset['cs'.$i]);?>>캡션사용</option>
				</select>
				&nbsp;
				<select name="wset[cf<?php echo $i;?>]">
					<option value="32"<?php echo get_selected('32', $wset['cf'.$i]);?>>32px</option>
					<option value="28"<?php echo get_selected('28', $wset['cf'.$i]);?>>28px</option>
				...
				<select name="wset[cc<?php echo $i;?>]">
					<option value="none"<?php echo(get_selected('none', $wset['cc'.$i]))?>>배경색없음</option>
