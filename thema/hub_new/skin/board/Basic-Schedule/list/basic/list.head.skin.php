...
<div class="calendar-head">
	<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=<?php echo $bo_table;?>&amp;year=<?php echo $year_prev;?>&amp;month=<?php echo $month_prev;?><?php echo $sca_qstr;?>" class="left fa-2x"><i class="fa fa-angle-left"></i></a>
	<h3 class="thisMonth">
		<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=<?php echo $bo_table;?>" title="이번달">
			<?php echo $year;?>.<?php echo $month;?>
		</a>
	</h3>
	<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=<?php echo $bo_table;?>&amp;year=<?php echo $year_next;?>&amp;month=<?php echo $month_next;?><?php echo $sca_qstr;?>" class="right fa-2x"><i class="fa fa-angle-right"></i></a>
</div>
