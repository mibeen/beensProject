...
if ($view['file']['count']) {
	for ($i=0; $i<count($view['file']); $i++) {
		if (isset($view['file'][$i]['source']) && $view['file'][$i]['source'] && !$view['file'][$i]['view']) {
			...
			$attach_list .= '<i class="fa fa-download"></i> '.$view['file'][$i]['source'].' ('.$view['file'][$i]['size'].') &nbsp;</a>'.PHP_EOL;
	...
	<article itemprop="articleBody">
		...
		<div class="print-hide view-icon view-padding">
			...
			<span class="pull-right">
				...
				<?php if ($scrap_href) { ?>
					<?php /*<img src="<?php echo G5_IMG_URL;?>/sns/scrap.png" alt="스크랩" class="cursor at-tip" onclick="win_scrap('<?php echo $scrap_href;  ?>');" data-original-title="스크랩" data-toggle="tooltip"> */ ?>
				<?php } ?>
				<?php if ($is_shingo) { ?>
