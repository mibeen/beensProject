...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			...
			<tr>
				<td align="center">펼침</td>
				<td colspan="2">
					<select name="wset[autowidth]">
						<option value=""<?php echo get_selected('', $wset['autowidth']);?>>사용안함</option>
						<option value="pc"<?php echo get_selected('pc', $wset['autowidth']);?>>기본 사이즈</option>
						<option value="lg"<?php echo get_selected('lg', $wset['autowidth']);?>>lg(1199px~)</option>
						<option value="md"<?php echo get_selected('md', $wset['autowidth']);?>>md(991px~)</option>
						<option value="sm"<?php echo get_selected('sm', $wset['autowidth']);?>>sm(767px~)</option>
						<option value="xs"<?php echo get_selected('xs', $wset['autowidth']);?>>xs(480px~)</option>
					</select>
				</td>
				<td align="center" colspan="2">펼침시 가로 사이즈</td>
				<td>
					<input type="text" name="wset[autowidth_size]" value="<?php echo $wset['autowidth_size']; ?>" class="frm_input" size="4"> px
				</td>
			</tr>
			</tbody>
			</table>
	...
	<tr>
		...
		<td>
			<label><input type="checkbox" name="wset[tit]" value="1"<?php echo get_checked('1', $wset['tit']);?>> 제목</label>
		</td>
	</tr>
	<?php /* (TEMP) 내용관련 옵션 숨김
	<tr>
	...
	*/ ?>
	...
	<tr>
		...
		<td>
			...
			<input type="text" name="wset[auto]" value="<?php echo $wset['auto']; ?>" class="frm_input" size="4"> ms
			<?php /*
			&nbsp;
	...
	<tr>
		...
		<td>
			...
			*/ ?>
			...
			<select name="wset[nav_size]">
				<option value="big"<?php echo get_selected('big', $wset['nav_size']);?>>큰 화살표</option>
				<option value="sm"<?php echo get_selected('sm', $wset['nav_size']);?>>작은 화살표</option>
			</select>
		</td>
	</tr>
	<tr>
