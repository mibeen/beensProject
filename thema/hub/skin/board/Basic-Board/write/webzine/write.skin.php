...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">설명</label>
	<div class="col-sm-10">
		<div class="input-group">
			<input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_subject" class="form-control input-sm" size="120" maxlength="255">
		</div>
	</div>
</div>

<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">프로필사진</label>
	<div class="col-sm-10">
		<div class="input-group col-md-12">
			<input type="file" name="nx-profile" id="nx-profile">
			<input type="hidden" name="wr_4" id="wr_4" value="<?php echo $write['wr_4']?>" class="wr_subject form-control input-sm" placeholder="사진을 업로드하시거나, 프로필 이미지의 링크를 적어주세요.">
			<?php 
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">작성자 설명</label>
	<div class="col-sm-10">
		<div class="input-group col-md-12">
