...
<div id="bo_w" class="write-wrap<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>">
	...
	<?php if ($is_category) { ?>
		<div class="form-group">
			<label class="col-sm-2 control-label hidden-xs" for="ca_name">구분<strong class="sound_only">필수</strong></label>
			<div class="col-sm-3">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<label class="control-label sp-label"><input type="radio" name="sh_14" value="on"<?php if($sh_14 != 'off'){echo(' checked');}?>> 완료</label>
			<label class="control-label sp-label"><input type="radio" name="sh_14" value="off"<?php if($sh_14 == 'off'){echo(' checked');}?>> 진행중</label>
		</div>
	</div>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="sh_1">발행번호<strong class="sound_only">필수</strong></label>
		<div class="col-sm-4">
			<div class="input-group">
				<input type="text" name="sh_1" value="<?php echo $sh_1 ?>" id="sh_1" required class="form-control input-sm" size="50" maxlength="255">
			</div>
		</div>
		<label class="col-sm-2 control-label" for="sh_2">ISBN<strong class="sound_only">필수</strong></label>
		<div class="col-sm-4">
			<div class="input-group">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="sh_3">발행처<strong class="sound_only">필수</strong></label>
		<div class="col-sm-4">
			<div class="input-group">
				<input type="text" name="sh_3" value="<?php echo $sh_3 ?>" id="sh_3" required class="form-control input-sm" size="50" maxlength="255">
			</div>
		</div>
		<label class="col-sm-2 control-label" for="sh_5">발행연월<strong class="sound_only">필수</strong></label>
		<div class="col-sm-4">
			<div class="input-group">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="sh_6">주제어<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10">
			<div class="input-group">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="sh_4">연구진<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10">
			<div class="input-group">
				<textarea type="text" name="sh_4" id="sh_4" required class="form-control"><?php echo $sh_4 ?></textarea>
			</div>
		</div>
	</div>
	...
	<div class="form-group">
		<label class="col-sm-2 control-label" for="sh_12">초록(국문)<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10">
			<div class="input-group">
				<textarea type="text" name="sh_12" id="sh_12" required class="form-control"><?php echo $sh_12 ?></textarea>
			</div>
		</div>
	</div>

	<div class="form-group">
		<label class="col-sm-2 control-label" for="sh_13">목차<strong class="sound_only">필수</strong></label>
		<div class="col-sm-10">
			<div class="input-group">
				<textarea type="text" name="sh_13" id="sh_13" required class="form-control"><?php echo $sh_13 ?></textarea>
			</div>
		</div>
	</div>
	<div class="form-group">
