...
$add_stylesheet .= PHP_EOL.'<link rel="stylesheet" href="'.COLORSET_URL.'/colorset.css?ver=180809" type="text/css" class="thema-colorset">';
$add_stylesheet .= PHP_EOL.'<link rel="stylesheet" href="'.THEMA_URL.'/assets/css/thema.css" type="text/css">';
add_stylesheet($add_stylesheet,0);
// add_stylesheet('<link rel="stylesheet" href="'.COLORSET_URL.'/colorset.css" type="text/css" class="thema-colorset">',1);


// For Miso-Company Start
// 위젯용
$atset = array();
$atset = $at_set;
...
// 기본값 설정
$is_thema_size = (isset($atset['size']) && $atset['size'] > 0) ? $atset['size'] : 1200;
$is_thema_font = ($atset['font']) ? $atset['font'] : 'ko';
$is_thema_layout = 'wided';
if($atset['layout'] == "1") {
	$is_thema_layout = 'boxed';
} else if($atset['layout'] == "2") {
	$is_thema_layout = 'boxed boxed-left';
} else if($atset['layout'] == "3") {
	$is_thema_layout = 'boxed boxed-right';
}
$is_thema_layout = ($is_index && $atset['idx']) ? 'wided' : $is_thema_layout;
$is_sticky_nav = $atset['sticky'];
$is_hmask = $atset['hmask'];
$is_hmask_fill = $atset['hfill'];
$is_hmask_over = $atset['hover'];
$is_fmask = $atset['fmask'];
$is_fmask_fill = $atset['ffill'];
$is_fmask_over = $atset['fover'];
$is_chk_page = ($is_index) ? ' is-index' : ' is-page';
$is_mh_bg = ($atset['mhbg']) ? $atset['mhbg'] : 'navy';

// For Miso-Company End
...
<div class="at-loader">
	<?php /* <div class="loader"><i class="fa fa-spinner fa-spin"></i></div> */ ?>
	<div class="loader"><img class="" src="<?php echo(THEMA_URL); ?>/assets/img/signature-basic.png" alt=""></div>
</div>
<?php } ?>