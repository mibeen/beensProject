...
<table style="width:100%;border-spacing:0;border-collapse:collapse;font-family:\'Nanum Gothic\',\'나눔고딕\',NanumGothic,\'맑은 고딕\',\'Malgun Gothic\',\'돋움\',dotum,Tahoma,Sans-serif" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td style="padding: 25px 30px;">
			...
			<tr>
				<td style="line-height:150%; font-size:16px; color:#222;">[#mng_mb_nick#] 시설관리자님,</td>
			</tr>
			<tr>
				<td style="line-height:150%; font-size:16px; color:#222;">[#lp_name#] 우리동네 학습공간 이용 신청이 접수되었습니다.</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="padding-bottom:5px;line-height:150%; font-size:14px; color:#222;">[시설관리자 페이지]-[학습공간 관리]-[예약현황]에서 <strong>승인</strong>하시기 바랍니다.</td>
			</tr>
			<tr>
				<td style="padding-bottom: 20px; line-height:150%; font-size:14px; color:#222;">
					<a href="[#LINK#]" style="display:inline-block;padding: 5px 10px;background:#3F9DE3;font-size:14px;color:#fff;text-decoration:none;">시설관리자페이지 바로가기</a>
				</td>
			</tr>
			<tr>
