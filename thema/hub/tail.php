	...
	<?php if(!$is_main_footer) { ?>
		<footer class="nx_footer_wrap">
			<nav class="footer-top">
				<ul>
					<li><a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=greeting">진흥원소개</a></li>
					...
					<li><a href="<?php echo G5_BBS_URL;?>/page.php?hid=noemail">이메일 수집거부</a></li>
			...
			<div class="nx_footer">
				...
				if (file_exists($footer_file)) {
					...
					echo '<img src="'.$footer_url.'" alt="footer">';
				}
				?>
				...
				<div class="nx_f_slogan">
					<img src="<?php echo(THEMA_URL)?>/assets/images/common/gg_slogan_grey.png" alt="">
				</div>
				<div class="nx_f_elogo">
					<?php
					/*
					$footer_file2 = G5_DATA_PATH.'/member/'.$footer_dir.'/footer_logo_img2.png';
					if (file_exists($footer_file2)) {
						$footer_url = G5_DATA_URL.'/member/'.$footer_dir.'/footer_logo_img2.png';
						echo '<img src="'.$footer_url.'" alt="footer">';
					}
					*/
					$footer_file3 = G5_DATA_PATH.'/member/'.$footer_dir.'/footer_logo_img3.png';
					if (file_exists($footer_file3)) {
...
function win_open2(url, heights)
{
	...
	/*
	$('#myModal-lg').modal('show').on('shown.bs.modal', function (e) {
		$('body').addClass('body-fixed');
	});
	$('#myModal-lg').modal().on('hidden.bs.modal', function (e) {
