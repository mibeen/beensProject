<?php
	...
	# get data
	$db1 = sql_fetch("Select EP.EP_IDX From NX_EVENT_PROJECT As EP Where EP.EP_DDATE is null And EP.EP_IDX = '" . mres($EP_IDX) . "' Limit 1");
	...
	$sql = "Update NX_EVENT_PROJECT Set"
	...
	$sql = "Delete From NX_EVENT_PROJECT_MEMBER Where EP_IDX = '" . mres($EP_IDX) . "'";
	sql_query($sql);
	...
	echo_json(array(
		...
		'redir'=>'project.list.php?'.$phpTail
	));
?>
