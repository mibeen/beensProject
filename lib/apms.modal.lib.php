	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-body">
				<div class="modal-top">
					<a href="javascript:void(0);" data-dismiss="modal" aria-hidden="true" class="modal-top-cls"><span class="ico_x"></span></a>
					<div id="viewModalTitle" class="modal-top-tit"></div>
				</div>
				...
				<div class="text-center cursor">
					<i class="fa fa-times circle medium light-circle bg-white border-gray gray" data-dismiss="modal" aria-hidden="true"></i>
				</div>
				*/ ?>
			</div>
		</div>
