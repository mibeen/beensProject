...
<!-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
		<div class="print-hide view-icon"  style="float:right;">
			<span class="pull-right">
				...
				<img src="<?php echo G5_IMG_URL;?>/sns/print.png" alt="프린트" class="cursor at-tip" onclick="apms_print();" data-original-title="프린트" data-toggle="tooltip" style="width:30px; margin-top:10px;">
			</span>
...
<section itemscope itemtype="http://schema.org/NewsArticle">
	<article itemprop="articleBody">
		...
		<div class="view-area thema-light-bg-color">
			<h1 class="nx-subject"><?php echo $view['wr_subject'] ?></h1>
			<p class="nx-desc"><?php echo $view['wr_2'] ?></p>
			<p class="nx-date"><?php echo date("Y.m.d", strtotime($view['wr_datetime'])); ?></p>
		</div>
		...
		<?php
		if(isset($view['wr_4']) && strlen($view['wr_4']) > 1){

			$img_src = $view['wr_4'];

		}else{
			$img_src = "/thema/themore/assets/images/user_thumbnail.png";
		}

		if(isset($view['wr_3']) && strlen($view['wr_3']) > 1 ){
			$nx_user_profile = "
				<div class=\"img-box\"><img src=\"".$img_src."\" alt=\"\"></div>
				<div class=\"txt-box\">".nl2br($view['wr_3'])."</div>
			";
		}else{
			$nx_user_profile = "프로필이 없습니다.";
		}
		?>
