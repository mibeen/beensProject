		...
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			...
			<?php 
				...
				for ($i=0; $i < $list_cnt; $i++) { 
					...
					$ex_row = sql_fetch("SELECT wr_1, wr_2, wr_3, wr_4 FROM g5_board_extend WHERE bo_table = '{$bo_table}' AND wr_id = {$list[$i]['wr_id']} ORDER BY id DESC LIMIT 0, 1")
				...
				<div class="list-row">
					<div class="list-item">
						...
						<div class="txt-box">
							...
							<?php
							$wr_3 = explode(',',$ex_row['wr_3']);
							$txt  = $wr_3[0];
							if(count($wr_3) > 1){
								$txt .= ' 외 '. (count($wr_3) - 1) . '곳';
							}
							?>
							...
							<strong>
								<a href="<?php echo $list[$i]['href'];?>"<?php echo $ellipsis;?>>
									...
									<?php } ?>
									<span class="thema-color"><?php echo $txt ?></span>
								</a>
							</strong>


							<div class="list-details font-12 text-muted">
								<span class="pull-left tag-list">
									<?php echo $list[$i]['as_tag'];?> <?php echo $list[$i]['as_tag'];?>
								</span>
								<div class="clearfix"></div>
							</div>
