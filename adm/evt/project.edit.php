<?php
	...
	# get data
	$sql = "Select EP.*"
		. " , (Select GROUP_CONCAT(DISTINCT mb_id SEPARATOR ', ') From NX_EVENT_PROJECT_MEMBER Where EP_IDX = " . mres($EP_IDX) . " Group By EP_IDX) As EPM_MEMB"
		. " From NX_EVENT_PROJECT As EP"
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="EP_S_DATE" id="EP_S_DATE" value="<?php echo htmlspecialchars($db_ep['EP_S_DATE']); ?>" class="nx-ips1 ws">
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="EP_E_DATE" id="EP_E_DATE" value="<?php echo htmlspecialchars($db_ep['EP_E_DATE']); ?>" class="nx-ips1 ws">
					...
					var dateFormat= "yy-mm-dd",
						from = $( "#EP_S_DATE" )
								.datepicker({
									...
									numberOfMonths: 1,
									dateFormat: "yy-mm-dd",
									maxDate : "<?php echo $db_ep["EP_E_DATE"]; ?>"
						...
						to = $( "#EP_E_DATE" ).datepicker({
									...
									numberOfMonths: 1,
									dateFormat: "yy-mm-dd",
									minDate : "<?php echo $db_ep["EP_S_DATE"]; ?>"
...
var onclCancel = function() {
	window.location.href="project.list.php?<?php echo($phpTail)?>";
}
