	...
	<div class="panel panel-default view-head<?php echo ($attach_list) ? '' : ' no-attach';?>">
	   ...
	   <?php
		...
		<div class="list-group font-12">
			<span class="list-group-item col-md-12"><i class="fa fa-bookmark"></i> 강의 경력 : <?=$result['wr_1']?></span>
			<!-- <span class="list-group-item col-md-12"><i class="fa fa-info-circle"></i> 강의 주제 : <?=$result['wr_2']?></i></span> -->
			<span class="list-group-item col-md-12"><i class="fa fa-graduation-cap"></i> 강의 장소 : <?=$result['wr_3']?></i></span>
			<span class="list-group-item col-md-12"><i class="fa fa-graduation-cap"></i> 강의 주제 : <?=$tag_list?></i></span>
