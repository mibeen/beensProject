...
<!--//-->
<form name="fauthlist2_copy" id="fauthlist2_copy" action="./auth_update_copy.php" method="post" autocomplete="off">
<section id="add_admin">
    <h2 class="h2_frm">관리권한 복사</h2>

    <div class="local_desc01 local_desc">
        <p>
            특정인에게 부여된 관리권한을 복사하는 기능입니다.<br>
            복사할 메뉴중 이미 권한이 부여된 메뉴가 하나라도 있으면 정상적으로 복사되지 않습니다.
        </p>
    </div>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
		<tr>
            <th scope="row"><label for="mb_id_copy">복사할 대상 회원아이디<strong class="sound_only">필수</strong></label></th>
            <td>
                <strong id="msg_mb_id_copy" class="msg_sound_only"></strong>
                <input type="text" name="mb_id_copy" value="" id="mb_id_copy" required class="required frm_input">
            </td>
			<td style="text-align:center;">
				<label style="font-size:15pt;">▷▶▷▶▷▶▷▶▷▶▷▶</label>
			</td>
            <th scope="row"><label for="mb_id_me">회원아이디<strong class="sound_only">필수</strong></label></th>
            <td>
                <strong id="msg_mb_id_me" class="msg_sound_only"></strong>
                <input type="text" name="mb_id_me" value="" id="mb_id_me" required class="required frm_input">
            </td>
        </tr>
        </tbody>
        </table>
    ...
    <div class="btn_confirm01 btn_confirm">
        <input type="submit" value="복사" class="btn_submit red">
    </div>
</section>
