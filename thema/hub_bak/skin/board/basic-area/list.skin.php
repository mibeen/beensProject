...
//add_stylesheet('<style>html{display: none;}</style>',1);
		...
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			...
			<?php 
				...
				for ($i=0; $i < $list_cnt; $i++) { 
					...
					$ex_row = sql_fetch("SELECT * FROM g5_board_extend WHERE bo_table = '{$bo_table}' AND wr_id = '".$list[$i]['wr_id']."' LIMIT 0, 1");
				...
				<div class="list-row">
					<div class="list-item">
						...
						<div class="list-details font-12 text-muted">
							<p class="pull-left">
								<span>문의전화</span> <span class="list-txt"><?php echo $ex_row['wr_1'];?></span>
							</p>
						...
						<div class="list-details font-12 text-muted">
							<p class="pull-left">
								<span>주소</span> <span class="list-txt"><?php echo $ex_row['wr_2'];?></span>
							</p>
