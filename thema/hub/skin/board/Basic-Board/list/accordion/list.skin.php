...
<div class="list-webzine">
  ...
  <div class="panel nx_faq">
    <div class="panel-heading nx_faq_top" role="tab" id="heading<?php echo $i; ?>">
      <h4 class="panel-title nx_panel_title">
		...
		<?php } ?>
			...
			<span class="nx_faq_q">
				<img src="/thema/<?php echo THEMA; ?>/skin/board/Basic-Board/list/accordion/imgs/Q.png" alt="">
			</span>
    ...
    <div id="collapse<?php echo $i; ?>" class="panel-collapse collapse <?php echo $collapse_in; ?>" role="tabpanel" aria-labelledby="heading<?php echo $i; ?>">
      <div class="panel-body nx_faq_ct" data-url="/thema/<?php echo THEMA; ?>/skin/board/Basic-Board/list/accordion/imgs/A.png">
      	<span class="nx_faq_a"><img src="/thema/<?php echo THEMA; ?>/skin/board/Basic-Board/list/accordion/imgs/A.png" alt=""></span>
      	<?php echo $list[$i]['content']; ?>
      </div>
      <?php echo "<a role=\"button\" href=\"{$list[$i]['href']}\" class=\"btn btn-white btn-sm\" title=\"글보기\"><i class=\"fa fa-plus\"></i><span class=\"hidden-xs\"> 글보기</span></a>"; ?>
    </div>
  </div>
	<?php } ?>
