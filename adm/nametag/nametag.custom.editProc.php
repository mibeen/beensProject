<?php
	...
	*/
	...
	if ($ENT_F4_SIZE > 127) $rfv[] = ['str'=>'D 내용 크기 정보가 잘못되었습니다.'];
	if ($ENT_F4_LEFT > 127) $rfv[] = ['str'=>'D 내용 크기 정보가 잘못되었습니다.'];
	if ($ENT_F4_RIGHT > 127) $rfv[] = ['str'=>'D 내용 크기 정보가 잘못되었습니다.'];
