...
<aside id="sidebar-box" class="<?php echo (isset($at_set['font']) && $at_set['font']) ? $at_set['font'] : 'ko';?>">
	...
	<!-- Head Line -->
	<div class="sidebar-head bg-<?php echo $line_top;?>">
		<a href="javascript:void(0);" class="sidebar-close ml10"><span class="ico_x"></span></a>
	</div>
	...
	<div id="sidebar-content" class="sidebar-content">
		...
		<div class="sidebar-common">
			...
			<div class="btn-group " role="group">
				<?php if($is_member) { ?>
					<a href="/my/evt.list.php" class="btn btn-nx-color btn-sm">마이페이지</a>
					<?php if($member['admin']) { ?>
			...
			function fn_member(no)
			{
				...
				if(no == 1)
					...
					win_open2('<?php echo(GSK_www_URL)?>/memb/myss.join.info', '600');
				else if(no == 3)
					win_open2('<?php echo(GSK_www_URL)?>/memb/myss.find.pw.input', '600');
			}
			</script>
