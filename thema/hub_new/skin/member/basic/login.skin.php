...
if(is_file(THEMA_PATH.'/skin/member/basic/style.css')){
	$skin_url = THEMA_URL . '/skin/member/basic';
}
...
<?php /*?>
<?php
$redirect_uri = isset($_GET['url']) ? clean_xss_tags(trim($_GET['url'])) : '';
?>
<script>
...
<div class="row">
	...
	<iframe src="<?php echo GSK_Auth_URL;?>?response_type=code&client_id=<?php echo GSK_client_id;?>&client_secret=<?php echo GSK_client_secret;?>&state=<?php echo GSK_state;?>&redirect_uri=<?php echo GSK_redirect_uri;?>" frameborder="0"></iframe>
				<style>
					iframe{width: 100%; height: 100%; min-width: 500px; min-height: 500px;}
				</style>
</div>
<?php */ ?>
