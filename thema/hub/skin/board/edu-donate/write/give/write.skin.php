...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_subject">교육기부 제목<strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_1">성명(기관명)</label>
	<div class="col-sm-10">
		<div class="input-group">
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_8">활동 지역</label>
	<div class="col-sm-10">
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_6">비용여부</label>
	<div class="col-sm-10">
		<div class="input-group" style="width:100%;">
			<textarea name="wr_6" id="wr_6" maxlength="255" class="form-control write-content" style="width:100%; height:100px;" placeholder="Ex. 교육 재료비, 교재비 등 발생 여부"><?php echo $write['wr_6'] ?></textarea>
		</div>
	</div>
</div>

<div class="form-group">
	<label class="col-sm-12" for="wr_content">강사소개 및 교육 내용</label>
	<div class="col-sm-12">
...
<div class="form-group">
	...
	<div class="col-sm-12">
		<div style="padding: 10px; border: 1px solid #ccc;">
			개인정보 수집·이용 내역<br>
			1. 수집목적 : 교육기부 매칭<br>
			2. 수집항목 : 성명, 연락처, 강사소개<br>
			3. 보유기간 : 경기도평생교육진흥원 홈페이지 교육기부 하기 게시글 삭제 시까지 <br>
			<br>
			위의 개인정보 수집·이용에 대한 동의를 거부할 권리가 있습니다.<br>
			그러나 동의를 거부할 경우 교육기부 하기 서비스를 이용하실 수 없습니다.
		</div>
	</div>
...
<div class="form-group">
	...
	<div class="col-sm-12">
		<div style="padding: 10px; border: 1px solid #ccc;">
			개인정보 제3자 제공 내역<br>
			1. 제공받는 자 : 불특정 다수(경기도평생교육진흥원 홈페이지 교육기부 하기 게시)<br>
			2. 이용 목적 : 교육기부 매칭<br>
			3. 제공 항목 : 성명, 연락처, 강사소개<br>
