...
$cols            = $wset['irows'];
$marginLeft      = isset($wset['marginLeft']) ? (int) $wset['marginLeft'] : 18;
...
<style>
	...
	@media screen and (min-width: 668px){
		#<?php echo $widget_id;?> .media {width: calc((100% - <?php echo ($cols - 1) * ($marginLeft + 1) ?>px) / <?php echo $cols; ?>);}
	}
</style>
<div id="<?php echo $widget_id;?>" class="nx-post-mix">
	<?php
