...
<div id="thema_wrapper" class="wrapper <?php echo $is_thema_layout;?> <?php echo $is_thema_font;?>">
	...
	<div class="header-wrapper <?php if (!$is_main) echo 'header-sub' ?>">
				...
				<div class="at-container">
					...
					<div class="header-logo">
						<a href="<?php echo $at_href['home'];?>">
							...
							if (file_exists($footer_file)) {
								...
								echo "<img src=\"" . G5_DATA_URL . "/member/" . $footer_dir . "/mb_mlogo_white.png\" alt=\"\">";
						...
						<input type="hidden" name="url"	value="<?php echo (IS_YC) ? $at_href['isearch'] : $at_href['search'];?>">
							<div>
								<input type="text" name="stx" value="<?php echo $stx;?>">
									...
									<button type="submit" class="btn btn-sm"><i class="fa fa-search"></i><span class="sound_only">검색</span></button>
					...
					<div class="nx_header_memb">
						...
						if($is_member) {
							...
							<?php } ?>
							<a href="/my/evt.list.php">마이페이지</a>
							...
							?>
							<a onclick="win_open2('<?php echo GSK_Auth_URL;?>?response_type=code&client_id=<?php echo GSK_client_id;?>&client_secret=<?php echo GSK_client_secret;?>&state=<?php echo GSK_state;?>&redirect_uri=<?php echo GSK_redirect_uri;?>', '600');" >로그인</a>
							<a onclick="win_open2('<?php echo(GSK_www_URL)?>/memb/myss.join.info?client_id=<?php echo GSK_client_id;?>&client_secret=<?php echo GSK_client_secret;?>', '800');">회원가입</a>
							<?php
						}
						?>
					...
					<a href="/bbs/search.php" class="nx_m_top_sch"><i class="fa fa-search fa-lg"></i></a>
					...
					<div class="header-wrap">
						<div class="header-logo en">
							...
							<a href="<?php echo $at_href['home'];?>">
								...
								if (file_exists($footer_file)) {
								?>
								<img src="<?php echo G5_DATA_URL.'/member/'.$footer_dir.'/mb_mlogo.png' ?>" alt="logo">
								<?php 
								}
								?>
							</a>
