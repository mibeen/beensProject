...
for ($i=0; $i<count($view['file']); $i++) {
	if (isset($view['file'][$i]['source']) && $view['file'][$i]['source'] && !$view['file'][$i]['view']) {
		...
		$attach_list .= '<i class="fa fa-download"></i>원문 다운로드</a>';
...
<div class="view-wrap<?php echo (G5_IS_MOBILE) ? ' view-mobile font-14' : '';?>">
	...
	<div class="area-wrap">
		...
		<p><span class="title">발행번호</span> <?php echo $result['wr_1'] ?></p>
		<p><span class="title">ISBN</span> <?php echo $result['wr_2'] ?></p>
		<p><span class="title">발행처</span> <?php echo $result['wr_3'] ?></p>
		<p><span class="title">연구진</span> <?php echo $result['wr_4'] ?></p>
		<p><span class="title">발행연월</span> <?php echo $result['wr_5'] ?></p>
		<p><span class="title">주제어</span> <?php echo $tag_list ?></p>
	</div>
	...
	<div class="view-content">
		<h3 class="area-title">초록(Abstract)</h3>
		<?php echo nl2br($result['wr_12']) ?>

		<h3 class="area-title">목차</h3>
		<?php echo nl2br($result['wr_13']) ?>

		<h3 class="area-title">내용</h3>
	...
	<i class="fa fa-commenting"></i> <span class="orangered">5</span> 댓글
	</div>
