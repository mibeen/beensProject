...
if($member['mb_level'] == 3){
	...
	$menu['menu100'] = array (
		array('100000', '환경설정', G5_ADMIN_URL.'/config_form.php',   'config', '/adm/imgs/comm/menu100'),
		array('100100', '기본환경설정', G5_ADMIN_URL.'/config_form.php',   'cf_basic'),
		array('100200', '관리권한설정', G5_ADMIN_URL.'/auth_list.php',     'cf_auth'),
		array('100210', '관리권한설정이력', G5_ADMIN_URL.'/auth_log.php',     'cf_auth_log'),
		...
		#array('100311', '메인슬라이드관리', G5_ADMIN_URL.'/mainslide.php', 'cf_mainslide'),
		...
		array('100700', '메인 위젯 관리',   G5_ADMIN_URL.'/nx/wedget/wedget.php',       'cf_phpinfo'),
