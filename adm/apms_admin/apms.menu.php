...
if($mode == 'menu') {
	...
	//config_table
	sql_query(" update {$g5['config_table']} set cf_10_subj = '{$_POST['cf_10_subj']}', cf_9_subj = '{$_POST['cf_9_subj']}', cf_9 = '{$_POST['cf_9']}' ", false);
...
<div class="tbl_head01 tbl_wrap">
	<ul style="padding:10px 30px; background:#f9f9f9; border:1px solid #f2f2f2; margin-bottom:10px; line-height:20px;">
		...
		<li>새글 표시 시간 : <input type="text" name="cf_9_subj" size="4" value="<?php echo ((int)$config['cf_9_subj'] >= 0) ? $config['cf_9_subj'] : 24; ?>" class="frm_input"> 시간 이내 등록된 자료가 있는 메뉴는 새글 표시('0' 입력시 새글표시 안함)</li>
