...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td align="center">날짜표시</td>
		<td>
			<label><input  type="checkbox" name="boset[wr_date]" value="1" <?php echo ($boset['wr_date'] == "1") ? ' checked' : '';?>/>  표시여부</label>
		</td>
	</tr>
	<tr>
		<td align="center">작성자 & 댓글 표시</td>
		<td>
			<label><input  type="checkbox" name="boset[wr_name]" value="1" <?php echo ($boset['wr_name'] == "1") ? ' checked' : '';?>/>  표시여부</label>
		</td>
	</tr>
	<tr>
		<td align="center">제목표시</td>
		<td>
			<label><input  type="checkbox" name="boset[wr_subject]" value="1" <?php echo ($boset['wr_subject'] == "1") ? ' checked' : '';?>/>  표시여부</label>
		</td>
	</tr>
	</tbody>
	</table>
