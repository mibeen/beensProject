<?php
    ...
    for ($i=0 ; $i<$rowCnt ; $i++){
        ...
        #가입자
        ${"sql_joinuser_month_".$i}       = "SELECT count(*) as cnt FROM gill.local_place_req where lr_wdate like '%".${"todayYearMonth_".$i}."%'";
	...
	*/
	...
	header("Content-Disposition: attachment; fileName=".iconv('utf-8', 'euc-kr', '우리동네학습공간_실적')."_" . date("ymd") . ".csv");
