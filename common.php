...
if ($_SESSION['ss_mb_id']) { // 로그인중이라면
    ...
    if ($tmp_mb_id = get_session('ck_mb_id')) {
...
$thema_row  = sql_fetch("SELECT data_1 FROM g5_apms_data WHERE type=11 ORDER BY id DESC LIMIT 0, 1");
$thema_skin = G5_PATH.'/thema/'.$thema_row['data_1'].'/'.G5_SKIN_DIR;
