			...
			if($_POST['type'][$i] == "board") {
				...
				$sql = " UPDATE {$g5['board_table']}
							set as_order				= '{$_POST['as_order'][$i]}'
								...
								, nx_depth2_yn				= '{$_POST['nx_depth2_yn'][$i]}'
...
<div id="wrapper">
    <div id="container">
		...
		<form id="menuform" name="menuform" method="post" action="<?php echo $_SERVER['SCRIPT_NAME']?>">
		...
		<div class="tbl_head01 tbl_wrap">
			...
			?>
				...
				<td align="center">
					<input type="checkbox" class="chk_depth2" name="nx_depth2_yn[<?php echo $z; ?>]" value="Y"<?php echo ($bo[$k]['nx_depth2_yn'] == 'Y' ? " checked" : ""); ?>>
				</td>
				<td align="center">
