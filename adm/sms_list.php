...
$sql_common = " from nx_sms Where ma_target = 'A' ";
...
<div class="btn_add01 btn_add">
    <a href="./sms_form.php" id="mail_add">SMS내용추가</a>
</div>

<form name="fmaillist" id="fmaillist" action="./sms_delete.php?ma_target=A" method="post">
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td><a href="./sms_form.php?w=u&amp;ma_id=<?php echo $row['ma_id'] ?>"><?php echo $row['ma_subject'] ?></a></td>
        <td class="td_datetime"><?php echo $row['ma_time'] ?></td>
        <td class="td_mngsmall"><a href="./sms_log.php?ma_target=A&ma_id=<?php echo $row['ma_id'] ?>">발송이력</a></td>
        <td class="td_test"><a href="./sms_test.php?ma_id=<?php echo $row['ma_id'] ?>">테스트</a></td>
        <td class="td_odrnum2"><a href="./sms_select_form.php?ma_id=<?php echo $row['ma_id'] ?>">회원보내기</a></td>
