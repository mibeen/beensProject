...
<div class="list-board">
	<div class="div-head <?php echo $head_class;?>">
		...
		<span class="wr-num hidden-xs">발행번호</span>
		<span class="wr-subject">제목</span>
		<span class="wr-date hidden-xs">발행연월</span>
	...
	?>
		<li class="list-item<?php echo $li_css;?>">
			...
			<?php } ?>
			<div class="wr-num hidden-xs"><?php echo $sql_row['wr_1']; ?></div>
			...
			<div class="wr-date hidden-xs"><?php echo date("Y년 m월",strtotime($list[$i]['wr_datetime']))?></div>
		</li>
	<?php } ?>
	</ul>
