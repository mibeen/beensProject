...
<div class="list-webzine">
  ...
  <div class="panel nx_faq">
    <div class="panel-heading nx_faq_top" role="tab" id="heading<?php echo $i; ?>">
      <h4 class="panel-title nx_panel_title">
		...
		<?php } ?>
			...
			<span class="nx_faq_q">
				<img src="<?php echo G5_SKIN_URL; ?>/board/basic-Accordion/img/ico_q.png" alt="">
			</span>
    ...
    <div id="collapse<?php echo $i; ?>" class="panel-collapse collapse <?php echo $collapse_in; ?>" role="tabpanel" aria-labelledby="heading<?php echo $i; ?>">
      <div class="panel-body nx_faq_ct" data-url="<?php echo G5_SKIN_URL; ?>/board/basic-Accordion/img/ico_a.png">
      	<span class="nx_faq_a"><img src="<?php echo G5_SKIN_URL; ?>/board/basic-Accordion/img/ico_a.png" alt=""></span>
