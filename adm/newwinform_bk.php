...
<div class=" tbl_wrap">
    ...
    <tr>
        ...
        <td>
            <label for="template_N">일반 모드</label><input type="radio" name="template" id="template_N" value="N">
            <label for="template_Y">템플릿 모드</label><input type="radio" name="template" id="template_Y" value="Y">
