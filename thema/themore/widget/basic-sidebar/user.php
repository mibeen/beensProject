...
<div class="sidebar-login">
	...
	<?php } else { //Logout ?>
		...
		<input type="hidden" name="url" value="<?php echo $urlencode; ?>">
			...
			<div class="form-group">
				<button type="submit" class="btn btn-nx-color btn-block" tabindex="93">로그인</button>    
			</div>	
		...
		<ul class="sidebar-list list-links">
			...
			<li><a href="https://www.gseek.kr/memb/find.pw.input" target="_blank">아이디/비밀번호 찾기</a></li>
			<?php
			/*
